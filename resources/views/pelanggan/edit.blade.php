...
@section('content')
    <div class="card m-auto col-10 mt-4 shadow-sm p-3 mb-5 bg-body-tertiary rounded">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('pelanggan_update', ['id' => $data->id]) }}" method="POST" class="mt-3">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-3">
                            <button type="submit" class="btn text-white" style="background-color: #F08080">Update</button>
                        </div>
                    </div>
                </div>
